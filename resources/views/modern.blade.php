    ...
    <div class="modal-body">
        <form action="" method="post" enctype="multipart/form-data" id="updateForm">  
            ...
            <div class="mb-3">
                ...
                <div class="mt-2">
                  <img id="existing_image_1" src="" alt="Existing Image" style="width: 100px; height:90px; display: none;">
              </div>
            </div>
            <div class="mb-3">
                <label for="icon-image" class="form-label">Image</label>
                ...
                <div class="mt-2">
                  <img id="existing_image_2" src="" alt="Existing Image" style="width: 100px; height:90px; display: none;">
              </div>
            </div> 
            <div class="mb-3">
                <label for="icon-name" class="form-label">Titale</label>
      ...
      <table class="table datatable">
        ...
        <tr>
           ...
           <td><img src="{{ asset('storage/' . $items->image_2) }}" alt="Image" width="90" height="70px;"></td> 
           <td>{{ $items->title }}</td>
            ...
            <td>
              ...
              <a class="btn btn-danger  btn-sm" href="{{ route('delete.mordern', ['id' => $items]) }}" onclick="return confirm('Are you sure?');">Delete</a>
            </td>
        </tr>
       @endforeach
       </tbody>
            ...
            success: function (response) {
                if (response.data) {
                   ...
                   if (response.data.image_1) {
                    $('#existing_image_1').attr('src', '/storage/' + response.data.image_1).show();
                   } else {
                    $('#existing_image_1').hide(); 
                   }
                   if (response.data.image_2) {
                    $('#existing_image_2').attr('src', '/storage/' + response.data.image_2).show();
                   } else {
                    $('#existing_image_2').hide(); 
                   }
